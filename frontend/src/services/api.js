...
export const studentAPI = {
  createActivity: (activityData) => api.post('/students/activity', activityData),
  getTodayActivities: () => api.get('/students/activity/today'),
  getAllActivities: () => api.get('/students/activity'),
  startSession: (sessionData) => api.post('/students/session/start', sessionData),
...
export const teacherAPI = {
  ...
  getStudentActivities: (studentId) => api.get(`/teachers/students/${studentId}/activities`),
  getStudentSessions: (studentId) => api.get(`/teachers/students/${studentId}/sessions`),
  getStudentRecords: (studentId) => api.get(`/teachers/students/${studentId}/records`),
