...
const StudentDashboard = () => {
  ...
  const loadData = async () => {
    try {
      const [activitiesRes, sessionsRes, activeSessionRes, exercisesRes] = await Promise.all([
        ...
        {activeSession && (
          <div className="bg-green-50 border-l-4 border-green-500 p-4 rounded-lg">
            <div className="flex justify-between items-center">
              <div>
                <h3 className="text-green-800 font-semibold">Active Study Session</h3>
                <p className="text-green-700 text-sm">
                  Subject: {activeSession.subject || 'Not specified'} | 
        ...
        <div className="bg-white rounded-lg shadow-sm">
          ...
          <div className="p-6">
            ...
            {activeTab === 'activity' && (
              <div className="space-y-6">
                <div className="card">
                  <h3 className="text-xl font-semibold mb-4">Log Academic Activity</h3>
                ...
                <div className="card">
                  <h3 className="text-xl font-semibold mb-4">Today's Activities</h3>
                  {activities.length === 0 ? (
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  {exercises.map((exercise) => (
                    <div key={exercise.id} className="border border-gray-200 rounded-lg p-4 hover:shadow-md transition-shadow">
                      ...
                      <p className="text-xs text-gray-500 mt-2 capitalize">Type: {exercise.type}</p>
                    </div>
                  ))}
                </div>
              </div>
